...
def contient0			#on a essayer plein de truc avec ça mais c la merde
	puts array.count{ |i| i.include? "0" }
end
...
def contientaude (x)			#on a essayer plein de truc avec ça mais c la merde

	puts "il y a #{x.count{ |i| i.include? "Aude".downcase }} \"Aude\" sans la majuscule"
	puts "il y a #{x.count{ |i| i.include? "Aude"}} \"Aude\" avec la majuscule"
