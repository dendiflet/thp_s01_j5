...
def longeurarray(arrayjournalistes)
	$a = arrayjournalistes.length.to_i
	print $a
end
#longeurarray(arrayjournalistes)

def contient0(arrayjournalistes)			#on a essayer plein de truc avec ça mais c la merde
	puts arrayjournalistes.count{ |i| i.include? "0" }
end
#contient0(arrayjournalistes)

def q2(arrayjournalistes)
...
def contientaude (arrayjournalistes)			#on a essayer plein de truc avec ça mais c la merde
